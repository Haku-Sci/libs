...
var MicroserviceLib_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.MicroserviceLib = void 0;
...
let MicroserviceLib = MicroserviceLib_1 = class MicroserviceLib {
    ...
    static async sendTCPMessage(service, messagePattern, payload) {
        const client = microservices_1.ClientProxyFactory.create({
            ...
            options: await MicroserviceLib_1.getServiceURI(service),
        });
        try {
...
exports.MicroserviceLib = MicroserviceLib;
exports.MicroserviceLib = MicroserviceLib = MicroserviceLib_1 = __decorate([
    (0, common_1.Injectable)()
], MicroserviceLib);
//# sourceMappingURL=microservice.libs.js.map